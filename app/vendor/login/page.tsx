...
export default function VendorLoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    setError("");
    const res = await signIn("vendor", { email, password, redirect: false });
    setLoading(false);
    if (res?.ok) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-gray-500 mt-1">Supplier portal</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full border border-gray-300 rounded-lg px-3 py-2 pr-16 text-sm text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-orange-500"
              />
              <button
                type="button"
